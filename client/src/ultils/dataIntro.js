export const text = {
  title: "Nhà Việt - Sự lựa chọn hàng đầu của bạn!",
  description:
    "Giải pháp cung cấp thông tin bất động chính xác và an toàn như: ",
  description2:
    "...Tiếp cận được với nhiều khách hàng hơn, do đó giao dịch nhanh hơn, tiết kiệm chi phí hơn",
  statistic: [
    {
      name: "Thành viên",
      value: "116.998+",
